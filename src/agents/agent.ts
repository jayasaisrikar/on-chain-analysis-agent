...
import { env } from "../env";
import { getQueryGeneratorAgent } from "./query-generator/agent";
import { getResearchAssistantAgent } from "./research-assistant/agent";
...
export const getRootAgent = () => {
	const queryAgent = getQueryGeneratorAgent();
	const researchAgent = getResearchAssistantAgent();
	...
	return AgentBuilder.create("root_agent")
		...
		.withSubAgents([queryAgent, researchAgent])
		.build();
};
